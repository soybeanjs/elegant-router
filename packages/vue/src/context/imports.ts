...
import type { ElegentRouterFile } from '@elegent-router/core';
import type { ElegentVueRouterOption } from '../types';
import { createFs } from '../shared/fs';

function getImportsCode(files: ElegentRouterFile[], options: ElegentVueRouterOption) {
...
export async function genImportsFile(files: ElegentRouterFile[], options: ElegentVueRouterOption) {
